...
<template>
    <div class="flex flex-col rounded-lg bg-white mx-auto my-auto items-center w-96 h-96">
        ...
        <div class="flex flex-col p-5 mx-5 my-5 w-full gap-y-3">
            <div class="flex flex-col">
                <label class="px-3 text-gray-600">Username</label>
                <input class="border-2 border-gray-300 rounded-lg p-2 text-base" placeholder="Username" v-model="username"/>
            </div>
            <div class="flex flex-col">
                <label class="px-3 text-gray-600">Password</label>
                <input class="border-2 border-gray-300 rounded-lg p-2 text-base" placeholder="Password" type="password" v-model="password"/>
            </div>
        </div>
        <div>
