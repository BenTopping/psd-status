...
def test_new_http_record():
    http_record = HttpRecord(1, True, 200.0, 201, "There was an error")
...
def test_create_http_record(app):
    with app.app_context():
        ...
        HttpRecord.create(monitor.id, True, 200.0, 201, "There was an error")
        ...
        assert db_http_record.success is True
